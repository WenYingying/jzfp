...
{
    public class SelectByHouse : AbstractFactory.IFactory<Model.PovertyArchives>
    {
        ...
        {
            string sqltext = string.Format("SELECT {0} FROM View_PovertyArchivesByHouse WHERE 1=1 {1}", select_list, select_search);
